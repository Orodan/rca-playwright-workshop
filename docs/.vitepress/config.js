...
export default defineConfig({
  ...
  themeConfig: {
    socialLinks: [{ icon: 'github', link: 'https://github.com/Orodan/rca-playwright-workshop' }],
    editLink: {
      pattern: 'https://github.com/Orodan/rca-playwright-workshop/edit/main/docs/:path',
